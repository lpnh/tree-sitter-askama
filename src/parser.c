...
enum ts_symbol_identifiers {
  ...
  sym_identifier = 92,
  sym__nested_comment = 93,
  sym_raw_content = 94,
  sym_source = 95,
  sym_comment = 96,
  sym__raw_block = 97,
  sym_raw_statement = 98,
  sym_endraw_statement = 99,
  sym_control_tag = 100,
  sym_render_expression = 101,
  sym__statement = 102,
  sym_block_statement = 103,
  sym_endblock_statement = 104,
  ...
  sym__conditional_statement = 111,
  sym_if_statement = 112,
  sym_let_condition = 113,
  sym_else_if_statement = 114,
  sym_match_statement = 115,
  sym_when_statement = 116,
  sym__match_pattern = 117,
  sym__pattern = 118,
  sym_tuple_pattern = 119,
  sym_tuple_struct_pattern = 120,
  sym_slice_pattern = 121,
  sym_or_pattern = 122,
  sym_with_pattern = 123,
  sym__pattern_destructure = 124,
  sym__destructure_element = 125,
  sym_remaining_field = 126,
  sym_macro_statement = 127,
  sym_endmacro_statement = 128,
  sym_macro_call_statement = 129,
  sym__expression = 130,
  sym__expression_except_range = 131,
  sym_binary_expression = 132,
  sym_string_concatenation = 133,
  sym_is_defined_expression = 134,
  sym_filter_expression = 135,
  sym__filter = 136,
  sym_macro_invocation = 137,
  ...
  sym__literal = 151,
  sym__negative_literal = 152,
  sym_boolean_literal = 153,
  sym__field_identifier = 154,
  aux_sym_source_repeat1 = 155,
  aux_sym_filter_statement_repeat1 = 156,
  aux_sym_tuple_pattern_repeat1 = 157,
  aux_sym_or_pattern_repeat1 = 158,
  aux_sym__pattern_destructure_repeat1 = 159,
  aux_sym_macro_call_statement_repeat1 = 160,
  aux_sym_string_concatenation_repeat1 = 161,
  aux_sym_arguments_repeat1 = 162,
  aux_sym_tuple_expression_repeat1 = 163,
  alias_sym_field_identifier = 164,
  alias_sym_token_tree = 165,
};
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(251);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(278);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 244,
    ...
    case 185:
      ACCEPT_TOKEN(anon_sym_let);
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(278);
      END_STATE();
    case 186:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym__raw_block] = STATE(130),
    [sym_raw_statement] = STATE(217),
    [sym_control_tag] = STATE(130),
    [sym_render_expression] = STATE(130),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(123)] = 6784,
  [SMALL_STATE(124)] = 6830,
  [SMALL_STATE(125)] = 6876,
  [SMALL_STATE(126)] = 6922,
  [SMALL_STATE(127)] = 6968,
  [SMALL_STATE(128)] = 7014,
  ...
  [SMALL_STATE(155)] = 7515,
  [SMALL_STATE(156)] = 7528,
  [SMALL_STATE(157)] = 7541,
  [SMALL_STATE(158)] = 7554,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_concatenation, 2, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_concatenation, 2, 0, 0),
  ...
  [109] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_concatenation_repeat1, 2, 0, 0), SHIFT_REPEAT(220),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 14),
  [114] = {.entry = {.count = 1, .reusable = false}}, SHIFT(206),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference_expression, 2, 0, 6),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference_expression, 2, 0, 6),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__filter, 1, 0, 2),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__filter, 1, 0, 2),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_expression, 3, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_expression, 3, 0, 0),
  ...
  [180] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_filter_statement_repeat1, 2, 0, 17), SHIFT_REPEAT(206),
  ...
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filter_expression, 2, 0, 7),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_filter_expression, 2, 0, 7),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_is_defined_expression, 3, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_is_defined_expression, 3, 0, 0),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 8),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 8),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__filter, 2, 0, 9),
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__filter, 2, 0, 9),
  ...
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_invocation, 3, 0, 13),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_macro_invocation, 3, 0, 13),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_filter_statement_repeat1, 2, 0, 3),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_filter_statement_repeat1, 2, 0, 3),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_expression, 2, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_expression, 2, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_expression, 3, 0, 15),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_expression, 3, 0, 15),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__field_identifier, 1, 0, 16),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__field_identifier, 1, 0, 16),
  ...
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 4, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 4, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_expression, 6, 0, 0),
  [285] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple_expression, 6, 0, 0),
  ...
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 5, 0, 22),
  [309] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [311] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_statement, 2, 0, 5),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_call_statement, 5, 0, 23),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_condition, 4, 0, 21),
  [319] = {.entry = {.count = 1, .reusable = true}}, SHIFT(139),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_statement, 2, 0, 6),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_call_statement, 6, 0, 25),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_statement, 4, 0, 21),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 4, 0, 21),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 2, 0, 5),
  ...
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  ...
  [385] = {.entry = {.count = 1, .reusable = false}}, SHIFT(203),
  ...
  [433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0),
  [435] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(131),
  [438] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(216),
  [441] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [444] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern, 1, 0, 0),
  [449] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_remaining_field, 1, 0, 0),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_control_tag, 3, 0, 0),
  [455] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_control_tag, 3, 0, 0),
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
  [459] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3, 0, 0),
  [461] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_pattern, 3, 0, 0),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slice_pattern, 3, 0, 0),
  [465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_struct_pattern, 3, 0, 20),
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_expression, 3, 0, 0),
  [469] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_render_expression, 3, 0, 0),
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_pattern, 4, 0, 0),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_endraw_statement, 3, 0, 0),
  [475] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_endraw_statement, 3, 0, 0),
  [477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slice_pattern, 4, 0, 0),
  [479] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_struct_pattern, 4, 0, 20),
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slice_pattern, 5, 0, 0),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__raw_block, 3, 0, 0),
  [485] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__raw_block, 3, 0, 0),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_struct_pattern, 5, 0, 20),
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple_pattern, 5, 0, 0),
  [491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slice_pattern, 2, 0, 0),
  ...
  [507] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or_pattern, 3, 0, 0),
  [509] = {.entry = {.count = 1, .reusable = true}}, SHIFT(128),
  [511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_pattern, 1, 0, 0),
  ...
  [521] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filter_statement, 3, 0, 10),
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or_pattern, 4, 0, 0),
  [525] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_or_pattern_repeat1, 2, 0, 0),
  [527] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_or_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(128),
  [530] = {.entry = {.count = 1, .reusable = false}}, SHIFT(223),
  [532] = {.entry = {.count = 1, .reusable = true}}, SHIFT(223),
  [534] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_endblock_statement, 1, 0, 0),
  [536] = {.entry = {.count = 1, .reusable = true}}, SHIFT(178),
  [538] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_endmacro_statement, 1, 0, 0),
  [540] = {.entry = {.count = 1, .reusable = true}}, SHIFT(170),
  [542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 3, 0, 11),
  ...
  [550] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern_destructure, 3, 0, 0),
  [552] = {.entry = {.count = 1, .reusable = true}}, SHIFT(134),
  [554] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_include_statement, 2, 0, 0),
  [556] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [558] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_statement, 3, 0, 12),
  [560] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_endmacro_statement, 2, 0, 1),
  [562] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tuple_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  [565] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tuple_pattern_repeat1, 2, 0, 0),
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_with_pattern, 3, 0, 0),
  [569] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_when_statement, 2, 0, 4),
  [571] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tuple_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(84),
  [574] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_statement, 2, 0, 1),
  [576] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 4, 0, 19),
  [578] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_endblock_statement, 2, 0, 1),
  [580] = {.entry = {.count = 1, .reusable = true}}, SHIFT(210),
  [582] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern_destructure, 4, 0, 0),
  [584] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__pattern_destructure_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [587] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__pattern_destructure_repeat1, 2, 0, 0),
  [589] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extends_statement, 2, 0, 0),
  ...
  [603] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_macro_call_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(218),
  [606] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_macro_call_statement_repeat1, 2, 0, 0),
  [608] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [610] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [612] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(63),
  ...
  [641] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_raw_statement, 3, 0, 0),
